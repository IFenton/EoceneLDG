## 30 / 4 / 2014
## Isabel Fenton
## Collecting the Environmental data from the ldg analysis for the bfd points
##
## Section 1 based on SST.R
## Section 2 based on Stratification.R (BFD/Code)
## N.B. t00mn (from Stratification.R) is the same as mean.t.depth
## Section 3 is based on ThermoclineStructure.R
## Section 5 based on ChlA.R
##
## Input: 
